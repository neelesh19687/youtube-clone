    ...
    <div className="container-fluid">
      ...
      <div className="search">
        <form className="d-flex my-2">
          <input className="form-control me-2" id="inputsearch" type="search" placeholder={(channelData.channelName !== undefined) && isSignedIn ? channelData.channelName : 'search'} aria-label="Search" />
          <Link to='/searchRes'>
